...
class AppDarkColors extends BaseColors {
  // --- Core Semantic ---
  @override
  Color get background => const Color(0xFF020617); // Slate 950

  @override
  Color get surface => const Color(0xFF0F172A); // Slate 900

  @override
  Color get surfaceVariant => const Color(0xFF1E293B); // Slate 800

  @override
  Color get surfaceElevated => const Color(0xFF1E293B); // Slate 800

  @override
  Color get onBackground => const Color(0xFFF8FAFC); // Slate 50

  @override
  Color get onSurface => const Color(0xFFF8FAFC); // Slate 50
  ...
  @override
  Color get primaryLight => const Color(0xFF1E1B4B); // Indigo 950
  ...
  @override
  Color get textTertiary => const Color(0xFF64748B); // Slate 500

  @override
  Color get textDisabled => const Color(0xFF475569); // Slate 600

  @override
  Color get textInverted => const Color(0xFF0F172A); // Slate 900

  @override
  Color get iconPrimary => primary;

  @override
  Color get iconSecondary => const Color(0xFF64748B); // Slate 500

  // --- Interactive States ---
  @override
  Color get disabled => const Color(0xFF1E293B); // Slate 800
  ...
  @override
  Color get error => const Color(0xFFF87171); // Red 400

  @override
  Color get warning => const Color(0xFFF59E0B); // Amber 500

  @override
  Color get info => const Color(0xFF60A5FA); // Blue 400
