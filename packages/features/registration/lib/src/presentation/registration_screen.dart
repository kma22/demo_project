...
import 'package:registration/src/config/l10n/localization_extension.dart';
...
import 'package:registration/src/presentation/widgets/password_field.dart';
...
class _RegistrationScreenState extends State<RegistrationScreen> {
          ...
          child: BlocConsumer<RegistrationCubit, RegistrationState>(
            listener: (context, state) {
              if (state is RegistrationSuccessState) {
                ...
                AppSnackBar.error(context, message: state.message ?? l10n.error);
              }
            },
                ...
                child: SingleChildScrollView(
                  ...
                  child: AutofillGroup(
                    child: Column(
                      ...
                      children: [
                        Text(l10n.title, style: textStyles.h1),
  ...
  String? _resolveError(
    RegistrationLocalizations l10n,
    ...
    return switch (error) {
      RegistrationValidationError.empty => switch (field) {
        RegistrationField.email => l10n.emailEmpty,
        RegistrationField.password => l10n.passwordEmpty,
        RegistrationField.confirmPassword => l10n.confirmPasswordEmpty,
      },
      RegistrationValidationError.invalidEmail => l10n.emailInvalid,
      RegistrationValidationError.passwordTooShort => l10n.passwordTooShort,
      RegistrationValidationError.passwordNoUppercase => l10n.passwordNoUppercase,
      RegistrationValidationError.passwordNoLowercase => l10n.passwordNoLowercase,
      RegistrationValidationError.passwordNoDigit => l10n.passwordNoDigit,
      RegistrationValidationError.passwordsDoNotMatch => l10n.passwordsDoNotMatch,
    };
  }
}
